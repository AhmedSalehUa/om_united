...
class AddAssetsCategory extends StatefulWidget {
  const AddAssetsCategory({Key? key}) : super(key: key);

  @override
  State<AddAssetsCategory> createState() => _AddAssetsCategoryState();
}

class _AddAssetsCategoryState extends State<AddAssetsCategory> {
  @override
  Widget build(BuildContext context) {
    return const MiniFragmnet(
      content: AddAssetsCategoryForm(),
    );
  }
}

class AddAssetsCategoryForm extends StatefulWidget {
  const AddAssetsCategoryForm({Key? key}) : super(key: key);

  @override
  State<AddAssetsCategoryForm> createState() => _AddAssetsCategoryFormState();
}

class _AddAssetsCategoryFormState extends State<AddAssetsCategoryForm> {
  String? forRent;
