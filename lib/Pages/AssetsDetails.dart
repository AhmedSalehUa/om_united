...
import '../FormPages/EditAsset.dart';
...
class AssetsDetails extends StatefulWidget {
  ...
  const AssetsDetails({Key? key, required this.item}) : super(key: key);
...
class _DetailsState extends State<Details> {
  ...
  void EditFunc() async {
    final result = await Navigator.push(context,
        MaterialPageRoute(builder: (context) => EditAsset(item: widget.item)));
    if (result == "done") {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        SubHeader(
          item: widget.item,Edit: EditFunc,
          Delete: Delete,
        ),
        Expanded(
          child: Container(
                    ...
                    showDialog(
                      ...
                      builder: (context) {
                        return CustomAlertDialog(
                          title: "هل انت متأكد من رغبتك في حذف الاصل",
